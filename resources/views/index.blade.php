            ...
            <div class="col-12 d-flex flex-wrap mb-4 p-3 border bg-light rounded-3">
                ...
                <div class="col-lg-2 col-md-6 col-sm-12 d-flex flex-column justify-content-center text-center">
                    ...
                    <div class="d-flex justify-content-end" style="gap: 0.5rem;">
                        <input type="text" class="input float-right required" name="consecutive_number"
                            id="consecutive_number" data-field-name="Número" style="width: 70px;" maxlength="6">
                        <input type="text" class="input float-right required" name="consecutive_serial" maxlength="4" data-field-name="Serial" style="width: 120px;">
                    </div>
