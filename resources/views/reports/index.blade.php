...
<div class="d-flex justify-content-center align-items-start" style="min-height: 80vh; padding-top: 2rem;">
    ...
    <h2 class="card-title mb-3"><i class="fa-solid fa-chart-line icon color-blue"></i> Informes</h2>
    <p class="fw-bold">Panel de reportes y estadísticas.</p>

    <hr>

    <!-- Aquí va el contenido de informes -->
