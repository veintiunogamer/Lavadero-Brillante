...
<div id="profile-root" class="d-flex justify-content-center align-items-start" style="padding-top: 2rem;" x-data="typeof profileApp === 'function' ? profileApp() : {}" x-init='if (typeof profileApp === "function") initData(window.userData)'>
